...
class TestHamiltonianModel(QiskitAerTestCase):
    ...
    def test_eigen_sorting(self):
        ...
        simple_ham = {
            "h_str": ["a*X0", "b*Y0", "c*Z0", "d*X0||D0"],
            "vars": {"a": 0.1, "b": 0.1, "c": 1, "d": 0.0},
            "qub": {"0": 2},
        }
        ...
        simple_ham = {
            "h_str": ["a*X0", "b*Y0", "c*Z0", "d*X0||D0"],
            "vars": {"a": 100, "b": 32.1, "c": 0.12, "d": 0.0},
            "qub": {"0": 2},
        }
    ...
    def test_no_variables(self):
        ...
        self.assertAlmostEqual(norm(qubit_lo - np.array([1.0])), 0)
