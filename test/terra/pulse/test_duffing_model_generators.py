...
class TestDuffingModelGenerators(QiskitAerTestCase):
    ...
    def test_duffing_system_model2(self):
        ...
        self._compare_str_lists(
            list(ham_model._channels), ["D0", "D1", "D3", "U0", "U1", "U2", "U3"]
        )
        ...
        exchange12 = self._operator_array_from_str(
            3, ["Sm", "Sp", "I"]
        ) + self._operator_array_from_str(3, ["Sp", "Sm", "I"])
        expected_terms = [
            ("np.pi*(2*v0-alpha0)", O0),
            ("np.pi*(2*v1-alpha1)", O1),
    ...
    def test_duffing_system_model3(self):
        ...
        exchange02 = self._operator_array_from_str(
            2, ["I", "Sm", "I", "Sp"]
        ) + self._operator_array_from_str(2, ["I", "Sp", "I", "Sm"])
        exchange03 = self._operator_array_from_str(
            2, ["Sm", "I", "I", "Sp"]
        ) + self._operator_array_from_str(2, ["Sp", "I", "I", "Sm"])
        exchange12 = self._operator_array_from_str(
            2, ["I", "Sm", "Sp", "I"]
        ) + self._operator_array_from_str(2, ["I", "Sp", "Sm", "I"])
        exchange13 = self._operator_array_from_str(
            2, ["Sm", "I", "Sp", "I"]
        ) + self._operator_array_from_str(2, ["Sp", "I", "Sm", "I"])
        expected_terms = [
            ("np.pi*(2*v0-alpha0)", O0),
            ("np.pi*(2*v1-alpha1)", O1),
            ("np.pi*(2*v2-alpha2)", O2),
    ...
    def test_duffing_hamiltonian_dict(self):
        ...
        output = model_gen._duffing_hamiltonian_dict(
            oscillators,
            oscillator_dims,
            oscillator_freqs,
            freq_symbols,
    ...
    def test_single_term_generators(self):
        ...
        self.assertEqual(
            model_gen._single_duffing_drift_terms(
                freq_symbols="v", anharm_symbols="a", system_list=0
            ),
